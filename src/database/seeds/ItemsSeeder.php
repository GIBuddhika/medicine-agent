    ...
    public function run()
    {
        ...
        DB::table('items')->insert([
            ...
            [
                ...
                'shop_id' => 1,
                'personal_listing_id' => null,
                'name' => 'Piriton syrup 200ml',
                'slug' => 'piriton-syrup-200ml',
            ...
            [
                ...
                'shop_id' => 1,
                'personal_listing_id' => null,
                'name' => 'Soframycin Cream 20G',
                'slug' => 'soframycin-cream-20g ',
                'description' => 'Skin care- Dermatology & sub specialties',
                'category_id' => 1,
                'quantity' => 50,
                'created_at' => Carbon::now(),
            ],
        ...
        DB::table('sellable_items')->insert([
            ...
            [
                ...
                'wholesale_minimum_quantity' => null,
            ],
            [
                'id' => 3,
                'item_id' => 4,
